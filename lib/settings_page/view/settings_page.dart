              ...
              children: [
                ...
                if (Platform.isAndroid)
                  InkWell(
                    ...
                    child: const ListTile(
                      ...
                      subtitle: Text(
                          SettingsConstants.notReceivingNotificationsSubtitle),
                    ),
                  ),
                InkWell(
                  onTap: () {
                    launchUrl(Uri.parse(MetaDataConstants.githubBugReportLink),
                ...
                InkWell(
                  ...
                  child: const ListTile(
                    ...
                    subtitle: Text(SettingsConstants.featureRequestSubheading),
                  ),
                ),
                InkWell(
                  onTap: () {
